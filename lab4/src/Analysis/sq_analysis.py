...
data = pd.read_csv('/home/iftekhar/EECE5554/lab4/src/Data/square2_3.csv')
...
# -----------------------------
#  Figure 8: Magnetometer N vs. E Components Before and After Calibration
# -----------------------------
...
plt.title('Figure 8a: Magnetometer N vs E (Before Calibration)')
...
plt.title('Figure 8b: Magnetometer N vs E (After Calibration)')
plt.xlabel('Magnetic Field X (North, µT)')
plt.ylabel('Magnetic Field Y (East, µT)')
plt.axis('equal')
...
# -----------------------------
# Figure 9: Gyroscope Rotational Rate vs. Time
# -----------------------------
...
plt.title('Figure 9: Gyroscope Rotational Rate - X Axis')
...
# -----------------------------
# Figure 10: Total Rotation (Integrated Gyroscope Data) vs. Time
# -----------------------------
...
plt.title('Figure 10: Total Rotation - X Axis')
...
# -----------------------------
# Figure 11: Magnetometer X and Y Components vs. Time
# -----------------------------
...
plt.subplot(2, 1, 1)
plt.plot(time, mag_x)
plt.title('Figure 11a: Magnetometer X Component vs. Time')
plt.ylabel('Magnetic Field X (µT)')

plt.subplot(2, 1, 2)
plt.plot(time, mag_y, color='orange')
plt.title('Figure 11b: Magnetometer Y Component vs. Time')
plt.xlabel('Time (samples)')
...
# -----------------------------
# Figure 12: Acceleration vs. Time
# -----------------------------
...
plt.subplot(3, 1, 1)
plt.plot(time, acc_x)
plt.title('Figure 12: Acceleration - X Axis')
...
plt.subplot(3, 1, 1)
plt.plot(time, vel_x)
plt.title('Figure 13: Velocity - X Axis')
...
# -----------------------------
# Figure 14: Displacement vs. Time
# -----------------------------
...
plt.title('Figure 14: Displacement - X Axis')
